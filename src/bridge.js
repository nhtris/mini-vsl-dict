 ...
 */
/** @internal */
var mabMessageQueue = new Map();
exports.mabMessageQueue = mabMessageQueue;
var mabCustomEventQueue = new Map();
exports.mabCustomEventQueue = mabCustomEventQueue;
var mabKeyboardEventQueue = new Map();
...
var MiniAppBridge = /** @class */ (function () {
    ...
    MiniAppBridge.prototype.execSuccessCallback = function (messageId, value) {
        var queueObj = mabMessageQueue.get(messageId);
        if (value) {
    ...
    MiniAppBridge.prototype.execCustomEventsCallback = function (eventType, value) {
        ...
        var queueObj = mabCustomEventQueue.get(event.type);
        if (!queueObj) {
            ...
            mabCustomEventQueue.set(event.type, event);
            this.executor.execEvents(event);
        }
        mabCustomEventQueue.delete(eventType);
    };
    /**
    ...
    MiniAppBridge.prototype.execKeyboardEventsCallback = function (eventType, message, navigationBarHeight, screenHeight, keyboardHeight) {
        ...
        var queueObj = mabKeyboardEventQueue.get(event.type);
        if (!queueObj) {
            if (eventType === event.type) {
    ...
    MiniAppBridge.prototype.sendToNative = function (eventType, params) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            return _this.executor.exec(eventType, params, function (id) { return resolve(id); }, function (error) { return reject(error); });
        });
    };
...
function removeFromMessageQueue(queueObj) {
    mabMessageQueue.delete(queueObj.id);
}
function removeFromEventQueue(queueObj) {
    mabCustomEventQueue.delete(queueObj.type);
}
function removeFromKeyboardEventQueue(queueObj) {
    mabKeyboardEventQueue.delete(queueObj.type);
}
...
var IOSExecutor = /** @class */ (function () {
    ...
    IOSExecutor.prototype.exec = function (action, param, onSuccess, onError) {
        ...
        common_bridge_1.mabMessageQueue.set(callback.id, callback);
